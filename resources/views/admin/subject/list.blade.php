      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1>Subjects List  (Total: {{$getRecord->total()}})</h1>
          </div>
              ...
              <form action="" method="get">
                <div class="card-body row">
                  <div class="form-group col-md-3">
                    <label >Name</label>
                    <input type="text" class="form-control" name="name" value="{{ Request::get('name') }}"  placeholder="Enter Subject Name">
                  </div>
                  <div class="form-group col-md-3">
                    ...
                    <select name="type" id="" class="form-control">
                      <option value="">select type</option>
                        ...
                        <option value="practicle" {{ (Request::get('type') == 'practicle')?  'selected' : '' }}>Practicle</option>
                    </select>
                  </div>
